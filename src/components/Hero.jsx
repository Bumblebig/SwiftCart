    ...
    return (
        <header className="pb-12">
                <div>
                    ...
                    <p className="text-gray-700 leading-normal m-auto text-sm">Welcome to SwiftCart, where passion meets product. Our journey began with a vision to redefine the way you shop. Dive into a world of carefully curated items that reflect our commitment to quality, style, and innovation.</p>
