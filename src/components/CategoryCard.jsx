export default function CategoryCard({image, text}) {
    ...
    return (
        <figure className="w-11/12 h-60 max-w-sm flex flex-col items-center justify-end p-3" style={style}>
            <div>
                <p className="text-white text-center text-base font-bold">{text}</p>
